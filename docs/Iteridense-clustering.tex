...
The author thanks Michael Klaiber, PhD for the fruitful discussion,
feedback and for the scientific proof-reading.
...
resolution. The possible resolutions are in the range two -- number
...
this paper. For comparison also a set of random data points was clustered.
All used datasets have each 1500~data points. \textbf{MinClusterSize}
was in all cases set to 75 (5\,\% of 1500). \ref{fig:Mean-size-and-density}\,(a)
shows the mean size of clusters in dependence of the resolution and
\ref{fig:Mean-size-and-density}\,(b) shows the mean density of clusters
